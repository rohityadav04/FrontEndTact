...
const Integers1_getters: ABIGetter[] = [
]

const Integers1_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"text","text":"show ops"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Deploy"}},
]

export class Integers1 implements Contract {
    
    static async init() {
        return await Integers1_init();
    }
    
    static async fromInit() {
        const init = await Integers1_init();
        const address = contractAddress(0, init);
        return new Integers1(address, init);
    }
    
    static fromAddress(address: Address) {
        return new Integers1(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  Integers1_types,
        getters: Integers1_getters,
        receivers: Integers1_receivers,
        errors: Integers1_errors,
    };
