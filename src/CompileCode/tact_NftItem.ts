...
function dictValueParserSetCollectionMetaData(): DictionaryValue<SetCollectionMetaData> {
  return {
    serialize: (src, buidler) => {
      buidler.storeRef(
        beginCell().store(storeSetCollectionMetaData(src)).endCell()
      );
    },
    parse: (src) => {
